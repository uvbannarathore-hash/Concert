...
from app.routes import auth_routes, chat_routes, concert_routes, booking_routes, admin_routes, wishlist_routes, voice_routes, telegram_routes, show_routes, dograh_routes
...
app.include_router(dograh_routes.router)
