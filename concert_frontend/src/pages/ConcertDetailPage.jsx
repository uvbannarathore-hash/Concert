...
export default function ConcertDetailPage() {
  ...
  function paymentDetailsValid() {
    ...
    return true // Wallet - nothing to validate, it's fake anyway
  }

  async function handlePay() {
    setError('')
    setStatus('booking')
    // Simulate a real payment gateway taking a moment - this is not a
    // real transaction, just a delay so the flow feels genuine.
